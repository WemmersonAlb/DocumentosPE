...
function ipva(){
    ...
    var mes = document.getElementById('mes').value       //captação de tratamento de dados
    ...
    if(veiculo<500){
        alert("Digite o valor válido para seu veículo")
    ...
    }else if(requisito_categoria == 1 && requisito_veiculo == 1){
        var resultado1 = document.getElementById('resultado1')//localiza onde o resultado deve ser exibido
